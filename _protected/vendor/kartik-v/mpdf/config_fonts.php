...
$this->fontdata = array(
    ...
    "national" => array(
        'R' => "THBaijam.ttf",
        'B' => "THBaijam-Bold.ttf",
        'I' => "THBaijam-Italic.ttf",
        'BI' => "THBaijam-BoldItalic.ttf"
    ),
    "thk2d" => array(
        'R' => "THK2D.ttf",
        'B' => "THK2D-Bold.ttf",
        'I' => "THK2D-Italic.ttf",
        'BI' => "THK2D-BoldItalic.ttf"
    ),
    //
...
$this->sans_fonts = array('thsaraban','national','thk2d','dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
